		...
		calculateResult: function() {
			...
			$.each(this.get("questions"), function(i,v){
				...
				result.forEach(function(r){
					if(typeof answers[r] == 'undefined') {
						answers[r] = 0;
					}
					console.log(r + ' : ' + answer.get('score'));
			...
			switch (true) {
			  case total >= 0 && total <= 15:
			  	$('.score').append('<span style="color: #930025"> ' + total + '</span>');
				winnerId = 1;
				break;
			  case total >= 16 && total <= 30:
			  	$('.score').append('<span style="color: #930025"> ' + total + '</span>');
				winnerId = 2;
				break;
			  case total >= 31 && total <= 45:
			  	$('.score').append('<span style="color: #930025"> ' + total + '</span>');
				winnerId = 3;
				break;
			  default:
